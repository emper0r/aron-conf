...
class Ui_DialogLic(object):
    def setupUi(self, DialogLic):
        ...
        DialogLic.setTabOrder(self.lineEditEmail, self.dateEditActive)
        DialogLic.setTabOrder(self.dateEditActive, self.dateEditExpire)
        DialogLic.setTabOrder(self.dateEditExpire, self.lineEditReq)
        DialogLic.setTabOrder(self.lineEditReq, self.lineEditLic)
        DialogLic.setTabOrder(self.lineEditLic, self.btGenerate)
